import{_ as i,r as a,o,c as d,a as n,d as e,b as s,w as c,e as p}from"./app-e7f8d9af.js";const m={},u={id:"cli",tabindex:"-1"},h=n("a",{class:"header-anchor",href:"#cli","aria-hidden":"true"},"#",-1),v={href:"https://github.com/dice-roller/cli",target:"_blank",rel:"noopener noreferrer"},b=p(`<h2 id="install" tabindex="-1"><a class="header-anchor" href="#install" aria-hidden="true">#</a> Install</h2><p>Install the script globally:</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">npm</span> <span class="token function">install</span> <span class="token parameter variable">-g</span> @dice-roller/cli
